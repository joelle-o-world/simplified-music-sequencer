    ...
    return (
      <div className="App">
        <DialogBox className="ChooseName">
          ...
          <ComposerField
            autoFocus
            onEnterPress={() => setPage("main")}
            noPlaceholder
          />
          <button className="RedButton" onClick={() => setPage("main")}>
            Begin
          </button>
        </DialogBox>
      </div>
    ...
    return (
      <div className="App">
        ...
        <footer className="AppFooter">
          made by <a href="http://joelleplow.co.uk">joelle</a> --{" "}
          <a href="https://github.com/joelyjoel/simplified-music-sequencer">
            view source code
          </a>
        </footer>
      </div>
